...
#see algo 1 in paper 
# 
diff_marg_likelihood_pred_sampl <- function(labeled_data,
                                            unlabeled_data,
                                            test_data,
                                            target,
                                            glm_formula) {
  ...
  for (i in seq(n_imp)) {
    ...
    #   marg_l_pseudo[[flip_count]] <- logistic_model %>% get_log_marg_l_sampl()
    ...
    marg_l_pseudo <- lapply(models_pseudo, get_log_marg_l_sampl)
